...
async function seed() {
  ...
  try {
    ...
    await client.query("TRUNCATE lab_requests, pmr_identifiers, pmr_forms, mlr_grievous_entries, mlr_injuries, mlr_reports, mlef_forms, police_officers, patients, users CASCADE;");
